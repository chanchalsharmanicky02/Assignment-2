...
<head>
  ...
  <style>
    ...
    #myId{
      background-color: rgb(183, 233, 134);
      height: 200px;
      width: 500px;
      text-transform: capitalize;
    }
    .myclass{
      ...
      margin: 10px;
      text-align: center;
      background-color: rgb(101, 186, 189);
    }
    .classbox{
    ...
    .box{
      background-color: rgb(236, 131, 149);
      color: rgb(31, 78, 3);
    }
    .Class{
    ...
    #MYid{
      background-color: rgb(187, 207, 113);
      color: rgb(61, 90, 2);
    }
    #MYId{
      background-color: rgb(228, 228, 144);
      color: rebeccapurple;
    }
    #MYID{
      background-color: rgb(198, 219, 155);
      color: brown;
    }
    [class="comm"]{
